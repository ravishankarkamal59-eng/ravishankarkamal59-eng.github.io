...
(function() {
  ...
  var SEARCH_INDEX = [
    ...
    // ========== AGRICULTURE ==========
    { title: 'Agriculture (कृषि)', url: 'agriculture.html', keywords: 'agriculture krishi kheti krishak कृषि खेती किसान farming', icon: '🌾', category: 'कृषि' },
    { title: 'Agri Study Material', url: 'agri-study-material.html', keywords: 'agri study material kheti krishi notes कृषि अध्ययन सामग्री', icon: '📚', category: 'कृषि' },
    { title: 'Agri Content Soil', url: 'agri-content-soil.html', keywords: 'agri soil content mitti मिट्टी', icon: '🌱', category: 'कृषि' },
    { title: 'Agri 11 Animal', url: 'agri-11-animal.html', keywords: 'agri 11 animal husbandry पशु पालन', icon: '🐄', category: 'कृषि Class 11' },
    { title: 'Agri 11 Biology', url: 'agri-11-biology.html', keywords: 'agri 11 biology जीव विज्ञान', icon: '🧬', category: 'कृषि Class 11' },
    { title: 'Agri 11 Crop', url: 'agri-11-crop.html', keywords: 'agri 11 crop science फसल विज्ञान', icon: '🌾', category: 'कृषि Class 11' },
    { title: 'Agri 11 Farm', url: 'agri-11-farm.html', keywords: 'agri 11 farm खेत', icon: '🚜', category: 'कृषि Class 11' },
    { title: 'Agri 11 Horticulture', url: 'agri-11-horticulture.html', keywords: 'agri 11 horticulture बागवानी', icon: '🍎', category: 'कृषि Class 11' },
    { title: 'Agri 11 Rural', url: 'agri-11-rural.html', keywords: 'agri 11 rural ग्रामीण', icon: '🏘️', category: 'कृषि Class 11' },
    { title: 'Agri 11 Soil', url: 'agri-11-soil.html', keywords: 'agri 11 soil मिट्टी विज्ञान', icon: '🌱', category: 'कृषि Class 11' },
    { title: 'Agri 12 Animal', url: 'agri-12-animal.html', keywords: 'agri 12 animal पशु', icon: '🐄', category: 'कृषि Class 12' },
    { title: 'Agri 12 Crop', url: 'agri-12-crop.html', keywords: 'agri 12 crop फसल', icon: '🌾', category: 'कृषि Class 12' },
    { title: 'Agri 12 Economics', url: 'agri-12-economics.html', keywords: 'agri 12 economics कृषि अर्थशास्त्र', icon: '💰', category: 'कृषि Class 12' },
    { title: 'Agri 12 Extension', url: 'agri-12-extension.html', keywords: 'agri 12 extension प्रसार शिक्षा', icon: '📢', category: 'कृषि Class 12' },
    { title: 'Agri 12 Genetics', url: 'agri-12-genetics.html', keywords: 'agri 12 genetics आनुवंशिकी', icon: '🧬', category: 'कृषि Class 12' },
    { title: 'Agri 12 Horticulture', url: 'agri-12-horticulture.html', keywords: 'agri 12 horticulture बागवानी', icon: '🍎', category: 'कृषि Class 12' },
    { title: 'Agri 12 Soil', url: 'agri-12-soil.html', keywords: 'agri 12 soil मिट्टी', icon: '🌱', category: 'कृषि Class 12' },
    { title: 'BSc Agronomy', url: 'bsc-agronomy.html', keywords: 'bsc agronomy शस्य विज्ञान', icon: '🌾', category: 'BSc Agriculture' },
    { title: 'BSc Agronomy Notes', url: 'bsc-agronomy-notes.html', keywords: 'bsc agronomy notes शस्य विज्ञान नोट्स', icon: '📚', category: 'BSc Agriculture' },
    { title: 'BSc Soil Science', url: 'bsc-soil-science.html', keywords: 'bsc soil science मृदा विज्ञान', icon: '🌱', category: 'BSc Agriculture' },
    { title: 'BSc Horticulture', url: 'bsc-horticulture.html', keywords: 'bsc horticulture बागवानी', icon: '🍎', category: 'BSc Agriculture' },
    { title: 'BSc Entomology', url: 'bsc-entomology.html', keywords: 'bsc entomology कीट विज्ञान', icon: '🐛', category: 'BSc Agriculture' },
    { title: 'BSc Extension Education', url: 'bsc-extension.html', keywords: 'bsc extension प्रसार शिक्षा', icon: '📢', category: 'BSc Agriculture' },
    { title: 'BSc Plant Pathology', url: 'bsc-plant-pathology.html', keywords: 'bsc plant pathology पादप रोग', icon: '🦠', category: 'BSc Agriculture' },
    { title: 'BSc Plant Breeding', url: 'bsc-plant-breeding.html', keywords: 'bsc plant breeding पादप प्रजनन', icon: '🌱', category: 'BSc Agriculture' },
    { title: 'BSc Plant Physiology', url: 'bsc-plant-physiology.html', keywords: 'bsc plant physiology पादप क्रिया विज्ञान', icon: '🌿', category: 'BSc Agriculture' },
    { title: 'BSc Animal Husbandry', url: 'bsc-animal-husbandry.html', keywords: 'bsc animal husbandry पशु पालन', icon: '🐄', category: 'BSc Agriculture' },
    { title: 'BSc Biochemistry', url: 'bsc-biochemistry.html', keywords: 'bsc biochemistry जैव रसायन', icon: '🧪', category: 'BSc Agriculture' },
    { title: 'BSc Microbiology', url: 'bsc-microbiology.html', keywords: 'bsc microbiology सूक्ष्म जीव विज्ञान', icon: '🔬', category: 'BSc Agriculture' },
    { title: 'BSc Forestry', url: 'bsc-forestry.html', keywords: 'bsc forestry वानिकी', icon: '🌳', category: 'BSc Agriculture' },
    { title: 'BSc Statistics', url: 'bsc-statistics.html', keywords: 'bsc statistics सांख्यिकी', icon: '📊', category: 'BSc Agriculture' },
    { title: 'BSc Agri Economics', url: 'bsc-agri-economics.html', keywords: 'bsc agri economics कृषि अर्थशास्त्र', icon: '💰', category: 'BSc Agriculture' },
    { title: 'BSc Agri Engineering', url: 'bsc-agri-engineering.html', keywords: 'bsc agri engineering कृषि अभियांत्रिकी', icon: '⚙️', category: 'BSc Agriculture' },
    { title: 'BHU Agriculture', url: 'bhu-agri.html', keywords: 'bhu agriculture bhu krishi बीएचयू कृषि', icon: '🎓', category: 'कृषि प्रवेश' },
    { title: 'ICAR JRF', url: 'icar-jrf.html', keywords: 'icar jrf agriculture exam आईसीएआर', icon: '📝', category: 'कृषि परीक्षा' },
    { title: 'ARS Agriculture', url: 'ars.html', keywords: 'ars agriculture scientist कृषि वैज्ञानिक', icon: '🔬', category: 'कृषि परीक्षा' },
